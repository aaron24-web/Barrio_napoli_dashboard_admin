...
export const useUpdateDeliveryManMutation = () => {
  ...
  return useMutation({
    ...
    onError: () => {
      toast.error('Error al actualizar el repartidor, por favor intente de nuevo.')
    },
  })
}
...
export const useToggleDeliveryManStatusMutation = () => {
  ...
  return useMutation({
    ...
    onError: () => {
      toast.error('Error al actualizar el estado del repartidor, por favor intente de nuevo.')
    },
  })
}
