...
import {
  ...
  type GetSalesTransactionsResponse,
  type MonthCanceledOrdersAmount,
  type MonthOrdersAmount,
  type MonthRevenue,
...
export const getSalesTransactions = async (
  ...
  const response = await apiClient.get('/metrics/sales-transactions', {
    params,
  })
  return response.data
}
